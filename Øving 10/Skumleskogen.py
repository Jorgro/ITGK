...
# En node er en dictionary med fÃ¸lgende felt:
...
def move_to(to_node):
  ...
  if cur["label"] in ('L', 'SL') and to_node in (cur["left"], cur["right"]):
    print("Du kan ikke gÃ¥ videre fra denne låsnoden uten å låse opp først!")
    return False
  elif to_node == None:
...
#C:\Python\ITGK-oppgaver\ITGK---Oppgaver
# hukommelse = {}
#
#
# def main(hukommelse):
...
#             main(hukommelse)
#
#     if hukommelse[n]['venstre'] and hukommelse[n]['hoyre']:
#         gaa_tilbake()
#
#
#
